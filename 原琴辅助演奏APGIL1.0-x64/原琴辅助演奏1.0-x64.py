...
sound1 = pygame.mixer.Sound(r'音频文件\h1.mp3')  
sound2 = pygame.mixer.Sound(r'音频文件\h2.mp3')
sound3 = pygame.mixer.Sound(r'音频文件\h3.mp3')
sound4 = pygame.mixer.Sound(r'音频文件\h4.mp3')
sound5 = pygame.mixer.Sound(r'音频文件\h5.mp3')
sound6 = pygame.mixer.Sound(r'音频文件\h6.mp3')
sound7 = pygame.mixer.Sound(r'音频文件\h7.mp3')
sound8 = pygame.mixer.Sound(r'音频文件\m1.mp3')
sound9 = pygame.mixer.Sound(r'音频文件\m2.mp3')
sound10 = pygame.mixer.Sound(r'音频文件\m3.mp3')
sound11 = pygame.mixer.Sound(r'音频文件\m4.mp3')
sound12 = pygame.mixer.Sound(r'音频文件\m5.mp3')
sound13 = pygame.mixer.Sound(r'音频文件\m6.mp3')
sound14 = pygame.mixer.Sound(r'音频文件\m7.mp3')
sound15 = pygame.mixer.Sound(r'音频文件\l1.mp3')
sound16 = pygame.mixer.Sound(r'音频文件\l2.mp3')
sound17 = pygame.mixer.Sound(r'音频文件\l3.mp3')
sound18 = pygame.mixer.Sound(r'音频文件\l4.mp3')
sound19 = pygame.mixer.Sound(r'音频文件\l5.mp3')
sound20 = pygame.mixer.Sound(r'音频文件\l6.mp3')
sound21 = pygame.mixer.Sound(r'音频文件\l7.mp3')
